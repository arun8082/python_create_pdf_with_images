        ...
        if os.path.exists( ref_full_path ):
            ...
            for f in files:
                ...
                if f[:3]=='REF':
                    ...
                    person_name = f'{person_details_series[4]}_{person_details_series[5]}_{person_details_series[6]}_{person_details_series[7]}'
                    
                    dup.append((person_name, encoded_string))
                    continue
                elif f == "Thumbs.db":
                    continue
                if not os.path.isdir(os.path.join(duplicate_dir, ref, f)):
